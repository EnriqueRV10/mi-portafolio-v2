    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-2 space-y-4 order-1 lg:order-2 text-neutral-300">
          ...
          <form
            id="contactForm"
            className="w-full space-y-9 rounded-lg p-5"
            name="contact"
            netlify
            method="POST"
          >
            <div className="flex justify-between gap-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 border-b-1 border-neutral-600 focus:outline-none focus:border-emerald-500 transition-colors"
                />
              </div>
            ...
            <div className="pt-2 w-40 mx-auto">
              <button
                type="submit"
                className="w-full bg-emerald-500 text-neutral-900 hover:bg-focus font-medium py-2 px-4 rounded-md hover:bg-emerald-600 transition-colors"
              >
                Enviar mensaje
              </button>
            </div>
